...
def process_escalation_decision(faq_response: str, customer_query: str) -> Dict[str, Any]:
    """
    ...
    if mock_mode:
        return mock_escalation_decision(faq_response, customer_query)
    else:
        return openai_escalation_decision(faq_response, customer_query)

def mock_escalation_decision(faq_response: str, customer_query: str) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        if isinstance(faq_response, str):
            try:
                ...
                response_data = {"confidence": 0.5, "category": "unknown"}
        else:
        ...
        return {
            ...
            "category": category,
            "human_agent_suggestion": suggest_agent_type(category, customer_query)
        }
...
def openai_escalation_decision(faq_response: str, customer_query: str) -> Dict[str, Any]:
    """
...
def suggest_agent_type(category: str, query: str) -> str:
    """
